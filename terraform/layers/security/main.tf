...
locals {
  ...
  img_upload_auth_secret = jsondecode(data.aws_secretsmanager_secret_version.app_secrets_value.secret_string)["API_GW_IMG_UPLOAD_AUTH_SECRET"]
}